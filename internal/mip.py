...
def conical_frustum_to_gaussian(d, t0, t1, base_radius, diag, a=0, f=1, l=0.5, stable=True):
...
def cast_rays(t_vals, origins, directions, radii, ray_shape, diag=True, a=0, f=1, l=0.5):
  ...
  if ray_shape == 'cone':
    ...
    assert False
  means, covs = gaussian_fn(directions, t0, t1, radii, diag, a=a, f=f, l=l)
...
def sample_along_rays(key, origins, directions, radii, num_samples, near, far,
                      randomized, lindisp, ray_shape, a=0, f=1, l=0.5):
  ...
  means, covs = cast_rays(t_vals, origins, directions, radii, ray_shape, a=a, f=f, l=l)
  return t_vals, (means, covs)


def resample_along_rays(key, origins, directions, radii, t_vals, weights,
                        randomized, ray_shape, stop_grad, resample_padding, a=0, f=1, l=0.5):
  """Resampling.
  ...
  means, covs = cast_rays(new_t_vals, origins, directions, radii, ray_shape, a=a, f=f, l=l)
